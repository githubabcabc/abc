...
proxies:
  ...
  - {name: 22161181, server: "192.168.1.1", port: 61181, type: socks5, skip-cert-verify: true, udp: true}
  - {name: 22161182, server: "192.168.1.1", port: 61182, type: socks5, skip-cert-verify: true, udp: true}
proxy-groups:
  - name: 🚀 节点选择
    type: select
    proxies:
